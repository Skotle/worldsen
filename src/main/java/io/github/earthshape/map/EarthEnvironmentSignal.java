...
public record EarthEnvironmentSignal(boolean heightActive, boolean climateActive, double height, double temperature, double humidity,
                                     double riverStrength, double normalSteepness, double desertStrength, double northChinaPlainStrength) {
    public static final EarthEnvironmentSignal INACTIVE = new EarthEnvironmentSignal(false, false, 0.5D, 0.5D, 0.5D, 0.0D, 0.0D, 0.0D, 0.0D);
}
