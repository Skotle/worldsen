...
public final class EarthShapeServerConfig {
   ...
   static {
      ...
      SNOW_ALTITUDE_BLOCKS = builder.comment("Surface Y level where high-altitude biomes may receive snow regardless of the temperature map.")
      ...
      RIVER_MINIMUM_WIDTH_BLOCKS = builder.comment(
            "Minimum generated width for a source river. 12 blocks keeps small rivers continuous across 4-block biome samples."
         )
      ...
      DESERT_WATER_REDUCTION_ENABLED = builder.comment(
            "Remove generated surface-water features on mapped land unless the location belongs to the river layer. Mapped ocean and underground water are left unchanged."
         )
         .define("enabled", true);
