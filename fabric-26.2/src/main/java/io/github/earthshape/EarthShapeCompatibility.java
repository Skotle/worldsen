...
public final class EarthShapeCompatibility {
   ...
   public static void initialize() {
      terralithLoaded = isLoaded("terralith");
      terraBlenderLoaded = hasRealTerraBlenderImplementation();
      biomesOPlentyLoaded = isLoaded("biomesoplenty");
      ...
      if (isLoaded("climaterivers") || isLoaded("climate_rivers")) {
   ...
   private static boolean hasRealTerraBlenderImplementation() {
      ...
      try {
         ClassLoader loader = EarthShapeCompatibility.class.getClassLoader();
         try {
            Class.forName("terrablender.core.TerraBlenderFabric", false, loader);
         } catch (ClassNotFoundException ignored) {
            Class.forName("terrablender.core.TerraBlenderNeoForge", false, loader);
         }
         return true;
      } catch (ClassNotFoundException ignored) {
         return false;
