...
public record CoastalContinentalnessDensity(DensityFunction argument) implements DensityFunction {
   ...
   private static final MapCodec<CoastalContinentalnessDensity> DATA_CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(DensityFunction.CODEC.fieldOf("argument").forGetter(CoastalContinentalnessDensity::argument))
   ...
   @Override public DensityFunction mapChildren(Visitor visitor) { return new CoastalContinentalnessDensity(visitor.apply(this.argument)); }
